					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<?php
								...
								{
									echo "<a href=\"//{$ipv4}/LookingGlass/dinosworkshop-com-{$val}.dltest\" class=\"btn btn-xs btn-default\">{$val}</a> ";
								}
							?>
							...
							<?php if (!empty($ipv6))
								{
									...
									foreach ($testFiles as $val)
									{
										echo "<a href=\"//[{$ipv6}]/LookingGlass/dinosworkshop-com-{$val}.dltest\" class=\"btn btn-xs btn-default\">{$val}</a> ";
									}
								}
							?>
